 ...
 */
ol_Overlay_Popup.prototype.show = function(coordinate, data) {
 ...
 * @private
 */
ol_Overlay_Popup.prototype._getHtml = function(data) {
  if (!data) return '';
  ...
  var content = ol_ext_element.create('DIV', { parent: bodyDIV});
  content.innerHTML = data.content;
  this.dispatchEvent({ type: 'select', data: data})
  return html;
};
