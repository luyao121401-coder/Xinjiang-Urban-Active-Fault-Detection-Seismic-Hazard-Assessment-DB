...
export function render(
  ...
  // console.log(stitchContext.canvas.toDataURL())

  const targetTopLeft = getTopLeft(targetExtent);
  console.log(targetTopLeft);
  ...
  triangulation.getTriangles().forEach(function (triangle, i, arr) {
    ...
    const affineCoefs = solveLinearSystem(augmentedMatrix); //重点 用以计算变换矩阵
    console.log(affineCoefs);
    if (!affineCoefs) {
      return;
    }
    ...
    console.log(sourceResolution / pixelRatio,
    -sourceResolution / pixelRatio);
