  ...
  <div class="m-page">
    <div class="urban_activity">
      ...
      <el-select style="width: 100%;" v-model="form.region" placeholder="选择图件类型">
        <el-option label="地震分布图" value="shanghai"></el-option>
        <el-option label="风险等级图" value="beijing"></el-option>
        <el-option label="经济损失图" value="3"></el-option>
        <el-option label="经济损失等级图" value="4"></el-option>
        <el-option label="人员伤亡图" value="5"></el-option>
        <el-option label="人员伤亡等级图" value="6"></el-option>
        <el-option label="区划风险防治图" value="7"></el-option>
      </el-select>
...
export default{
  ...
  methods:{
    gomapsRecords(){
      this.$router.push({name: "mapsRecords", params:{name: '地震灾害风险普查成果图'}})
    }
  }
}
</script>
